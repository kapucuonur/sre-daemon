...
## Corpus Check
- 24 files · ~31,342 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 548 nodes · 777 edges · 23 communities (15 shown, 8 thin omitted)
...
Cohesion: 0.01
Nodes (209): Incident: Auto-remount Healing: [BikeFit-API], Incident: Autonomous Healing: [AI-Coach], Incident: Autonomous Healing: [AI-Coach], Incident: Autonomous Healing: [AI-Coach], Incident: Autonomous Healing: [AI-Coach], Incident: Autonomous Healing: [AI-Coach], Incident: Autonomous Healing: [Another_mockservice], Incident: Autonomous Healing: [Another_mockservice] (+201 more)
...
## Knowledge Gaps
- **240 isolated node(s):** `deploy_to_pi.sh script`, `install.sh script`, `journal_to_file.sh script`, `graphify`, `Workflow: graphify` (+235 more)
